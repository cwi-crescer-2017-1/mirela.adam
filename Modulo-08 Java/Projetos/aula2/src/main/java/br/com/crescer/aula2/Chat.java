...
import br.com.crescer.exerciciosaula1.StringUtils;
import br.com.crescer.exerciciosaula1.StringUtilsImpl;
...
public class Chat {
    ...
    public static void main(String[] args) {
        if (args.length < 2) {
            args = new String[]{"\\\\10.0.100.102\\cwitmp\\carloshenrique\\aula.txt", "@mirelahaag"};
        }
